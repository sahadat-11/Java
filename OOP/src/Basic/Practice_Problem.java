...
class Employeee{
    ...
    public int getSalary(){ // salary int return type
        return salary;
    }
    public String getName(){ // stirng return type;
        return name;
    }
...
public class Practice_Problem {
    public static void main(String[] args) {
        ...
        sq.side = 3;
        System.out.println(sq.area());  // get value
        System.out.println(sq.perimeter());  // get value
